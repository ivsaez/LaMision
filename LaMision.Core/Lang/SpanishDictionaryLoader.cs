...
namespace LaMision.Core.Lang
{
    internal class SpanishDictionaryLoader : IDictionaryLoader
    {
        public IEnumerable<Word> Words => new List<Word>
        {
            ...
            new Word("insultarExtrano_1_interaction_description", "Insultar al extraño"),
            new Word("insultarExtrano_insulto_1", "Estás hecho polvo. ¡Saco de mierda!"),
            new Word("insultarExtrano_insulto_2", "Te queda medio telediario bastardo."),
            new Word("insultarExtrano_insulto_3", "Pegas como una madre."),
            new Word("insultarExtrano_insulto_4", "No te vas a comer los turrones cabronazo."),
            new Word("insultarExtrano_respuesta_1", "Me lo dices tú, que eres el más tonto en quilómetros a la redonda. Literalmente."),
            new Word("insultarExtrano_respuesta_2", "Tu mamá no opina lo mismo."),
            new Word("insultarExtrano_respuesta_3", "Llámame papá, idiota."),

            new Word("preguntarExtrano_1_interaction_description", "Preguntarle algo extraño"),
            new Word("preguntarExtrano_pregunta_1", "¿Cómo te llamas?"),
            new Word("preguntarExtrano_pregunta_2", "¿Cómo has llegado aquí?"),
            new Word("preguntarExtrano_pregunta_3", "¿Dónde está el enemigo?"),
            new Word("preguntarExtrano_pregunta_4", "¿Por qué me atacas?"),
            new Word("preguntarExtrano_respuesta_1", "Ya sabes eso, ¡no finjas!"),
            new Word("preguntarExtrano_respuesta_2", "Como si tu no lo supieras ya, sabandija."),
            new Word("preguntarExtrano_respuesta_3", "La única respuesta que te voy a dar son mis puños."),

            new Word("calmarExtrano_1_interaction_description", "Calmar al extraño"),
            new Word("calmarExtrano_frase_1", "Intenta calmarte."),
            new Word("calmarExtrano_frase_2", "La violencia no es la solución."),
            new Word("calmarExtrano_frase_3", "No somos enemigos, esta pelea no tiene sentido."),
            new Word("calmarExtrano_frase_4", "Vamos a solucionar esto hablando."),
            new Word("calmarExtrano_respuesta_1", "Ya intentas otra vez tus artimañas. No te van a servir más conmigo."),
            new Word("calmarExtrano_respuesta_2", "No me creo nada de una rata como tú."),
            new Word("calmarExtrano_respuesta_3", "Cuanto más hablas más me apetece cerrarte la boca de una hostia."),
