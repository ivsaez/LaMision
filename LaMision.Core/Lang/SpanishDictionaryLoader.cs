...
namespace LaMision.Core.Lang
{
    internal class SpanishDictionaryLoader : IDictionaryLoader
    {
        public IEnumerable<Word> Words => new List<Word>
        {
            ...
            new Word("mensajeLevanta3_1_interaction_description", "Suena una locución"),
            new Word("mensajeLevanta3_text_1", "Suena la voz de Natalia por el altavoz del dispositivo."),
            new Word("mensajeLevanta3_voz_1", "Arriba Simón. ¡Ánimo!"),
            new Word("mensajeLevanta3_voz_2", "No te rindas Simón, estás a punto de conseguirlo."),
            new Word("mensajeLevanta3_voz_3", "Yo creo en ti Simón, debes continuar."),
            new Word("mensajeLevanta3_voz_4", "Los yankees Simón, se acercan. No te pares ahora."),
